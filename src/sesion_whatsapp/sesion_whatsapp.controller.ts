...
export class SesionWhatsappController {
  constructor(private readonly sesionWhatsappService: SesionWhatsappService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSesionWhatsappDto: UpdateSesionWhatsappDto) {
